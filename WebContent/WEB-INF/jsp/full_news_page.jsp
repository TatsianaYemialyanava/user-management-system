...
<body>
	...
	<a href="Controller?command=localization&language=ru&commandRedirect=Controller%3Fcommand%3Dgo_to_full_news_page%26id=${param['id']}"><spring:message code="ru.button" /></a><br>

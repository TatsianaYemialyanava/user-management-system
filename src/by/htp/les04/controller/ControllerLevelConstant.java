...
public interface ControllerLevelConstant {
	...
	String REQUESTDISPATCHER_FROM_GO_TO_EDIT_PAGE_TO_EDIT_PAGE = "edit";
	String REQUESTDISPATCHER_FROM_GO_TO_ERROR_PAGE_TO_ERROR_PAGE = "error_page";
	String REQUESTDISPATCHER_FROM_GO_TO_FULL_USER_INFORMATION_PAGE_TO_FUll_USER_INFORMATION_PAGE = "view";
	String REQUESTDISPATCHER_FROM_GO_TO_INDEX_PAGE_TO_MAIN_INDEX = "login";
	String REQUESTDISPATCHER_FROM_GO_TO_MAIN_PAGE_TO_MAIN = "list";
	String REQUESTDISPATCHER_FROM_GO_TO_REGISTRATION_PAGE_TO_REGISTRATION = "new";
